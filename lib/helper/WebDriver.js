...
class WebDriver extends Helper {
  ...
  isCustomLocatorStrategyDefined() {
    return typeof this.customLocatorStrategy === 'function';
  }

  async _res(locator) {
    const res = (this._isShadowLocator(locator) || this.isCustomLocatorStrategyDefined())
  ...
  async _startBrowser() {
    ...
    if (this.isCustomLocatorStrategyDefined()) {
  ...
  */
  ...
  async _locate(locator, smartWait = false) {
    ...
    if (!this.options.smartWait || !smartWait) {
      if (this.isCustomLocatorStrategyDefined()) {
        return this.browser.custom$$('customlocatorstrategy', locator);
      }
...
async function proceedSee(assertType, text, context, strict = false) {
  ...
  console.log('\n\nthis.browser.getElementText ==== ', this.browser.getElementText);
  const selected = await forEachAsync(res, async el => this.browser.getElementText(getElementId(el)));
  console.log('\n\n$$$$$$$$$$$$$$$$$$$ selected ', selected);
  if (strict) {
