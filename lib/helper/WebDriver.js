...
class WebDriver extends Helper {
  ...
  _isCustomLocator(locator) {
    ...
    if (locatorObj.isCustom()) {
      ...
      throw new Error(`Please define Custom Locator Strategy as a function: "${locatorObj.type}" in WebDriver helpers configuration: WebDriver: { ...customLocatorStrategies: {custom : <function>}}`);
    }
    return false;
  }
